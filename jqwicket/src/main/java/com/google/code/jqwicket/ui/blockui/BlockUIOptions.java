...
public class BlockUIOptions extends AbstractJQOptions<BlockUIOptions> {
	...
	/**
	 * styles for the message when blocking; if you wish to disable these and
	 * use an external stylesheet then do this in your code:
	...
	/**
	 * styles applied when using $.growlUI <br>
	 * defaults:<br>
	 * 
	 * <pre>
	 * growlCSS: { 
	 ...
	 * (hat tip to Jorge H. N. de Vasconcelos) <br>
	 * default:<br>
	 * 
	 * <pre>
	...
	/**
	 * force usage of iframe in non-IE browsers (handy for blocking applets) <br>
	 * default:<br>
	 * 
	 * <pre>
	 * forceIframe: false
	...
	/**
	 * z-index for the blocking overlay <br>
	 * default:<br>
	 * 
	 * <pre>
	 * baseZ: 1000
	...
	/**
	 * set these to true to have the message automatically centered (only
	 * effects element blocking (page block controlled via css above) )<br>
	 * default:<br>
	 * 
	 * <pre>
	 * centerX: true
	...
	/**
	 * set these to true to have the message automatically centered <br>
	 * default:<br>
	 * 
	 * <pre>
	 * centerY: true
	 ...
	 * content (if bindEvents is true)<br>
	 * default:<br>
	 * 
	 * <pre>
	...
	/**
	 * fadeIn time in millis; set to 0 to disable fadeIn on block<br>
	 * default:<br>
	 * 
	 * <pre>
	 * fadeIn:  200
	...
	/**
	 * fadeOut time in millis; set to 0 to disable fadeOut on unblock <br>
	 * default:<br>
	 * 
	 * <pre>
	 * fadeOut:  400
	...
	/**
	 * disable if you don't want to show the overlay <br>
	 * default:<br>
	 * 
	 * <pre>
	 * showOverlay: true
	...
	/**
	 * don't ask; if you really must know: <a
	 * href="http://groups.google.com/group/jquery-
	 * en/browse_thread/thread/36640a8730503595
	 * /2f6a79a77a78e493#2f6a79a77a78e493
	 * ">http://groups.google.com/group/jquery-
	 * en/browse_thread/thread/36640a8730503595
	 * /2f6a79a77a78e493#2f6a79a77a78e493</a> <br>
	 * default:<br>
	 * 
	 * <pre>
