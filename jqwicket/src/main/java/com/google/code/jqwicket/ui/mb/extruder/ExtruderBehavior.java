...
public class ExtruderBehavior extends JQComponentBehaivor<ExtruderOptions>
	...
	public ExtruderBehavior(String title) {
		this(title, null);
	}

	public ExtruderBehavior(String title, String url) {
		this(new ExtruderOptions(title, url));
	}

	public ExtruderBehavior(ExtruderOptions options) {
		super(options);
	}
