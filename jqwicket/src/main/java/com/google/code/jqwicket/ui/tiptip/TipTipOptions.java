...
public class TipTipOptions extends AbstractJQOptions<TipTipOptions> {
	...
	/**
	 * ("hover" by default) - jQuery method TipTip is activated with. Can be set
	 * to: "hover", "focus" or "click".
	 * 
	 * @param activation
	 * @return
	 */
	...
	/**
	 * (false by default) - When set to true the TipTip will only fadeout when
	 * you hover over the actual TipTip and then hover off of it.
	 * 
	 * @param keepAlive
	 * @return
	 */
	...
	/**
	 * ("200px" by default) - CSS max-width property for the TipTip element.
	...
	/**
	 * (3 by default) - Distances the TipTip popup from the element with TipTip
	 * applied to it by the number of pixels specified.
	 * 
	 * @param edgeOffset
	 * @return
	 */
	...
	/**
	 * ("bottom" by default) - Default orientation TipTip should show up as. You
	 * can set it to: "top", "bottom", "left" or "right".
	 * 
	...
	/**
	 * (400 by default) - Number of milliseconds to delay before showing the
	 * TipTip popup after you mouseover an element with TipTip applied to it.
	 * 
	 * @param delay
	 * @return
	 */
	...
	/**
	 * ("title" by default) - HTML attribute that TipTip should pull it's
	 * content from.
	 * 
	 * @param attribute
	 * @return
	...
	/**
	 * (false by default) - HTML or String to use as the content for TipTip.
	...
	/**
	 * Custom function that is run each time you mouseover an element with
	 * TipTip applied to it.
	 * 
	 * @param callbackBody
	 * @return
	 */
	...
	/**
	 * Custom function that is run each time you mouseout of an element with
	 * TipTip applied to it.
	 * 
	 * @param callbackBody
	 * @return
