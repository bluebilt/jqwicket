...
public interface IUploadify extends IJQWidget<UploadifyOptions> {
	...
	static final CharSequence JQ_COMPONENT_NAME = "uploadify";
	 ...
	 *            added to the queue.
	 */
	void uploadifyCancel(AjaxRequestTarget ajaxRequestTarget, CharSequence id);
	 ...
	 * 
	 */
	void uploadifySettings(AjaxRequestTarget ajaxRequestTarget,
	 ...
	 *            begin uploading.
	 */
	void uploadifyUpload(AjaxRequestTarget ajaxRequestTarget, CharSequence id);
