...
import com.google.code.jqwicket.ui.guider.GuiderButton;
import com.google.code.jqwicket.ui.guider.GuiderCloseButton;
import com.google.code.jqwicket.ui.guider.GuiderItem;
import com.google.code.jqwicket.ui.guider.GuiderNextButton;
import com.google.code.jqwicket.ui.guider.GuiderOptions;
...
public class GuiderPage extends DemoPage {
	...
	public GuiderPage() {
		...
		GuiderItem item1 = new GuiderItem(
				new GuiderOptions()
						.buttons(
								new GuiderNextButton(Utils.i18n("button.next",
										this)))
						.description(
		...
		GuiderItem item2 = new GuiderItem(new GuiderOptions()
				.attachTo(myGuider)
				.buttons(new GuiderCloseButton("Close"),
						new GuiderNextButton("Next"))
		...
		GuiderItem item3 = new GuiderItem(
				new GuiderOptions()
						...
						.buttons(
								new GuiderButton(
										"Close, then click on the element.",
										"guider.hideAll"),
		...
		GuiderItem item4 = new GuiderItem(
				new GuiderOptions()
						.attachTo(myGuider)
						.buttons(
								new GuiderButton("Exit Guide", "guider.hideAll"),
								new GuiderButton("Continue", "guider.next"))
						.buttonCustomHTML(
